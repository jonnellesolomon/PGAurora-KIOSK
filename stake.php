  ...
  <div class="content-wr">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="title-h1">
            <h1><i class="fa fa-handshake"></i> Stakeholders</h1>
          </div>
         </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
         <div class="col-md-12">
          ...
          <div class="row">  
              <?php
                $query1=mysqli_query($conn,"SELECT * FROM  `stakeholders`
                        order by date          ")or die(mysqli_error($conn));
            ...
            <a href="view_stake.php?view=<?php echo $row['id'];?>">
            <button type="submit" class="btn btn-sm btn-success mt-1"><i class="fa fa-search"></i> View File</button></center>
                 </div>
