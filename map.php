  ...
  <div class="content-wr">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="title-h1">
            <h1><i class="fa fa-map-pin"></i> Maps</h1>
          </div>
         </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
         <div class="col-md-12">
          ...
          <div class="row">  
              <?php
                $query1=mysqli_query($conn,"SELECT * FROM  `map`
              ...
              <div class="card bg-light d-flex flex-fill">
                ...
                <center><video class="image-view" id="video"  width="100%" src="../admin/pdf/<?php echo $files[0];?>"></video>
        <button type="submit" class="btn btn-sm btn-success mt-1"><i class="fa fa-search"></i> View Full Map</button></a></center>
                 </div>
