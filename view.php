 ...
 <!-- <audio autoplay><source src="sounds/notif.wav" type=""></audio> -->
  ...
  <div class="main-map">
    <div class="row">
     <div class="col-md-12">
       <div class="title-h1">
          <a href="map.php"><i class="fa fa-arrow-left" ></i></a>
             <?php
                   $cid=$_GET['view'];
                   $ret=mysqli_query($conn,"select * from map where id='$cid'");
                   $cnt=1;
    ...
    <div class="card card-solid map">
             ...
             <video class="map-view" id="video" height="700px" width="100%" src="../admin/pdf/<?php echo $files[0];?>" autoplay loop muted></video>
