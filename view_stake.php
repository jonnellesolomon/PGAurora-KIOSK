 ...
 <audio autoplay><source src="sounds/notif.wav" type=""></audio>
  ...
  <div class="main-map">
    <div class="row">
     <div class="col-md-12">
       <div class="title-h1">
          <a href="stake.php"><i class="fa fa-arrow-left" ></i></a>
             <?php
                   $cid=$_GET['view'];
                   $ret=mysqli_query($conn,"select * from stakeholders where id='$cid'");
                   $cnt=1;
    ...
    <div class="card card-solid map" style="background: rgba( 255, 255, 255, 0.70 ); 
