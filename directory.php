  ...
  <div class="content-wr">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="title-h1">
            <h1> <i class="fa fa-folder-open"></i> Directory</h1>
          </div>
         </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="container-fluid">
        <div class="row">
         <div class="col-md-12">
          ...
          <div class="row">  
              <?php
                $query1=mysqli_query($conn,"SELECT * FROM  `directory`
              ...
              <div class="card bg-light d-flex flex-fill">
                ...
                <center>
                  <img class="image-view" id="video"  width="100%" src="../admin/pdf/<?php echo $files[0];?>"></img>
                  <a href="view_dir.php?view=<?php echo $row['id'];?>"><button type="submit" class="btn btn-sm btn-success mt-1"><i class="fa fa-search"></i>View File</button></a></center>
                 </div>
